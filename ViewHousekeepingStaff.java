 ...
 */
public class ViewHousekeepingStaff {
    private JFrame jFrame1;
    private JPanel panel;
    private JTable table;
    private DefaultTableModel model;
    private JScrollPane scrollPane;
    ViewHousekeepingStaff(ArrayList<HousekeepingStaff> housekeepingStaffs)
    {
        table=new JTable();
        panel=new JPanel();
        int rows=housekeepingStaffs.size()-1;
        int no=1;
        int c=1;
        ...
        jFrame1.add(panel);
        jFrame1.setTitle("Housekeeping Database");
        jFrame1.pack();
